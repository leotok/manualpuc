...
class AtividadesViewController: UIViewController {
    ...
    func addLayout() {
        ...
        label1.center = CGPoint( x: self.view.frame.width / 1.85 , y: self.view.frame.height / 19 )
        ...
        let label21 = UILabel()
        label21.frame.size = CGSize( width: self.view.frame.width / 2 , height: self.view.frame.height / 1.4 )
        label21.center = CGPoint( x: self.view.frame.width / 3.7 , y: self.view.frame.height / 2.7 )
        ...
        let label22 = UILabel()
        label22.frame.size = CGSize( width: self.view.frame.width / 2.162 , height: self.view.frame.height / 1.4 )
        label22.center = CGPoint( x: self.view.frame.width / 1.345 , y: self.view.frame.height / 2.6 )
        ...
        let label4 = UILabel()
        label4.frame.size = CGSize( width: self.view.frame.width / 1.133 , height: self.view.frame.height / 3 )
        label4.center = CGPoint( x: self.view.frame.width / 2.000 , y: self.view.frame.height / 1.35 )
