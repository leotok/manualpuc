...
class UniversidadeViewController: UIViewController,SWRevealViewControllerDelegate {
    ...
    func addLayout() {
        ...
        button1.addTarget(self, action: #selector(UniversidadeViewController.curiosidadeAction), for: UIControlEvents.touchUpInside)
        ...
        button2.addTarget(self, action: #selector(UniversidadeViewController.utilidadeAction), for: UIControlEvents.touchUpInside)
